...
//
//    val (invocationVar, c1) = Ctx.withCapability(input.context):
...
//      irv
//
//    val decoration = IR.SvInst(Op.OpDecorate, invocationVar :: Decoration.BuiltIn :: BuiltIn.GlobalInvocationId :: Nil)
//
//    val (prevPrefix, inputs) = c1.prefix.partitionMap:
...
//    )
//
//    val c2 = c1.copy(prefix = prefix ++ prevPrefix, decorations = decoration :: c1.decorations, globalVariables = invocationVar :: c1.globalVariables)
//
