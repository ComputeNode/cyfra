...
private[cyfra] object Opcodes:
  ...
  object GlslOp:
    ...
    val FAbs = Code("FAbs", 4)
    val SAbs = Code("SAbs", 5)
    val FSign = Code("FSign", 6)
    val SSign = Code("SSign", 7)
    val Floor = Code("Floor", 8)
    val Ceil = Code("Ceil", 9)
    val Fract = Code("Fract", 10)
    val Radians = Code("Radians", 11)
    val Degrees = Code("Degrees", 12)
    val Sin = Code("Sin", 13)
    val Cos = Code("Cos", 14)
    val Tan = Code("Tan", 15)
    val Asin = Code("Asin", 16)
    val Acos = Code("Acos", 17)
    val Atan = Code("Atan", 18)
    val Sinh = Code("Sinh", 19)
    val Cosh = Code("Cosh", 20)
    val Tanh = Code("Tanh", 21)
    val Asinh = Code("Asinh", 22)
    val Acosh = Code("Acosh", 23)
    val Atanh = Code("Atanh", 24)
    val Atan2 = Code("Atan2", 25)
    val Pow = Code("Pow", 26)
    val Exp = Code("Exp", 27)
    val Log = Code("Log", 28)
    val Exp2 = Code("Exp2", 29)
    val Log2 = Code("Log2", 30)
    val Sqrt = Code("Sqrt", 31)
    val InverseSqrt = Code("InverseSqrt", 32)
    val Determinant = Code("Determinant", 33)
    val MatrixInverse = Code("MatrixInverse", 34)
    val Modf = Code("Modf", 35)
    val ModfStruct = Code("ModfStruct", 36)
    val FMin = Code("FMin", 37)
    val UMin = Code("UMin", 38)
    val SMin = Code("SMin", 39)
    val FMax = Code("FMax", 40)
    val UMax = Code("UMax", 41)
    val SMax = Code("SMax", 42)
    val FClamp = Code("FClamp", 43)
    val UClamp = Code("UClamp", 44)
    val SClamp = Code("SClamp", 45)
    val FMix = Code("FMix", 46)
    val Step = Code("Step", 48)
    val SmoothStep = Code("SmoothStep", 49)
    val Fma = Code("Fma", 50)
    val Frexp = Code("Frexp", 51)
    val FrexpStruct = Code("FrexpStruct", 52)
    val Ldexp = Code("Ldexp", 53)
    val PackSnorm4x8 = Code("PackSnorm4x8", 54)
    val PackUnorm4x8 = Code("PackUnorm4x8", 55)
    val PackSnorm2x16 = Code("PackSnorm2x16", 56)
    val PackUnorm2x16 = Code("PackUnorm2x16", 57)
    val PackHalf2x16 = Code("PackHalf2x16", 58)
    val PackDouble2x32 = Code("PackDouble2x32", 59)
    val UnpackSnorm2x16 = Code("UnpackSnorm2x16", 60)
    val UnpackUnorm2x16 = Code("UnpackUnorm2x16", 61)
    val UnpackHalf2x16 = Code("UnpackHalf2x16", 62)
    val UnpackSnorm4x8 = Code("UnpackSnorm4x8", 63)
    val UnpackUnorm4x8 = Code("UnpackUnorm4x8", 64)
    val UnpackDouble2x32 = Code("UnpackDouble2x32", 65)
    val Length = Code("Length", 66)
    val Distance = Code("Distance", 67)
    val Cross = Code("Cross", 68)
    val Normalize = Code("Normalize", 69)
    val FaceForward = Code("FaceForward", 70)
    val Reflect = Code("Reflect", 71)
    val Refract = Code("Refract", 72)
    val FindILsb = Code("FindILsb", 73)
    val FindSMsb = Code("FindSMsb", 74)
    val FindUMsb = Code("FindUMsb", 75)
    val InterpolateAtCentroid = Code("InterpolateAtCentroid", 76)
    val InterpolateAtSample = Code("InterpolateAtSample", 77)
    val InterpolateAtOffset = Code("InterpolateAtOffset", 78)
