...
//import io.computenode.cyfra.spirv.archive.SpirvConstants.{DEBUG_PRINTF_REF, TYPE_VOID_REF}
//import io.computenode.cyfra.spirv.archive.Context
//import io.computenode.cyfra.spirv.archive.SpirvTypes.{GBooleanTag, Int32Tag, LInt32Tag}
//
//object GIOCompiler:
//
