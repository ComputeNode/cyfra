...
object GCodec:
  ...
  def toByteBuffer[CyfraType <: Value: {FromExpr, Tag}, ScalaType: ClassTag](inBuf: ByteBuffer, arr: Array[ScalaType])(using
    gc: GCodec[CyfraType, ScalaType],
  ): ByteBuffer =
    gc.toByteBuffer(inBuf, arr)

  def fromByteBuffer[CyfraType <: Value: {FromExpr, Tag}, ScalaType: ClassTag](outBuf: ByteBuffer, arr: Array[ScalaType])(using
    gc: GCodec[CyfraType, ScalaType],
  ): Array[ScalaType] =
