...
/** Free-slip boundary conditions with density/temperature dissipation.
  *
  * Velocity slides tangentially along surfaces (proper free-slip). Density and temperature gradually fade at boundaries to prevent accumulation.
  */
object DissipativeBoundaryProgram:
