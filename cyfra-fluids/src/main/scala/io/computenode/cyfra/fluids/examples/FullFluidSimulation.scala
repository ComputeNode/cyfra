...
object FullFluidSimulation:
  ...
  def buildPipeline(): GExecution[Int, SimulationLayout, SimulationLayout] =
    GExecution[Int, SimulationLayout]()
      ...
      .addProgram(OutflowBoundaryProgram.create)(
        totalCells => totalCells,
        layout => FluidState(
          velocity = layout.velocityPrevious,  // Clear in PREVIOUS buffer (used by advection)
          pressure = layout.pressurePrevious,
          density = layout.densityPrevious,
          temperature = layout.temperaturePrevious,
          divergence = layout.divergence,
      ...
      .addProgram(ProjectionProgram.pressureSolve)(totalCells => totalCells, layout => FluidStateDouble(velocityCurrent = layout.velocityCurrent, pressureCurrent = layout.pressurePrevious, densityCurrent = layout.densityCurrent, temperatureCurrent = layout.temperatureCurrent, divergenceCurrent = layout.divergence, velocityPrevious = layout.velocityPrevious, pressurePrevious = layout.pressureCurrent, densityPrevious = layout.densityPrevious, temperaturePrevious = layout.temperaturePrevious, divergencePrevious = layout.divergence, obstacles = layout.obstacles, params = layout.params))
      .addProgram(ProjectionProgram.pressureSolve)(totalCells => totalCells, layout => FluidStateDouble(velocityCurrent = layout.velocityCurrent, pressureCurrent = layout.pressureCurrent, densityCurrent = layout.densityCurrent, temperatureCurrent = layout.temperatureCurrent, divergenceCurrent = layout.divergence, velocityPrevious = layout.velocityPrevious, pressurePrevious = layout.pressurePrevious, densityPrevious = layout.densityPrevious, temperaturePrevious = layout.temperaturePrevious, divergencePrevious = layout.divergence, obstacles = layout.obstacles, params = layout.params))
      .addProgram(ProjectionProgram.pressureSolve)(totalCells => totalCells, layout => FluidStateDouble(velocityCurrent = layout.velocityCurrent, pressureCurrent = layout.pressurePrevious, densityCurrent = layout.densityCurrent, temperatureCurrent = layout.temperatureCurrent, divergenceCurrent = layout.divergence, velocityPrevious = layout.velocityPrevious, pressurePrevious = layout.pressureCurrent, densityPrevious = layout.densityPrevious, temperaturePrevious = layout.temperaturePrevious, divergencePrevious = layout.divergence, obstacles = layout.obstacles, params = layout.params))
      .addProgram(ProjectionProgram.pressureSolve)(totalCells => totalCells, layout => FluidStateDouble(velocityCurrent = layout.velocityCurrent, pressureCurrent = layout.pressureCurrent, densityCurrent = layout.densityCurrent, temperatureCurrent = layout.temperatureCurrent, divergenceCurrent = layout.divergence, velocityPrevious = layout.velocityPrevious, pressurePrevious = layout.pressurePrevious, densityPrevious = layout.densityPrevious, temperaturePrevious = layout.temperaturePrevious, divergencePrevious = layout.divergence, obstacles = layout.obstacles, params = layout.params))
      .addProgram(ProjectionProgram.pressureSolve)(totalCells => totalCells, layout => FluidStateDouble(velocityCurrent = layout.velocityCurrent, pressureCurrent = layout.pressurePrevious, densityCurrent = layout.densityCurrent, temperatureCurrent = layout.temperatureCurrent, divergenceCurrent = layout.divergence, velocityPrevious = layout.velocityPrevious, pressurePrevious = layout.pressureCurrent, densityPrevious = layout.densityPrevious, temperaturePrevious = layout.temperaturePrevious, divergencePrevious = layout.divergence, obstacles = layout.obstacles, params = layout.params))
      .addProgram(ProjectionProgram.pressureSolve)(totalCells => totalCells, layout => FluidStateDouble(velocityCurrent = layout.velocityCurrent, pressureCurrent = layout.pressureCurrent, densityCurrent = layout.densityCurrent, temperatureCurrent = layout.temperatureCurrent, divergenceCurrent = layout.divergence, velocityPrevious = layout.velocityPrevious, pressurePrevious = layout.pressurePrevious, densityPrevious = layout.densityPrevious, temperaturePrevious = layout.temperaturePrevious, divergencePrevious = layout.divergence, obstacles = layout.obstacles, params = layout.params))
  ...
  @main def runFullFluidSimulation(): Unit =
    ...
    try
      ...
      val numFrames = 200  // Test with just 5 frames first
      ...
      val params = FluidParams(
        dt = 0.2f,              // Time step
        viscosity = 0.01f,    // Low viscosity (smoke is not very viscous)
      ...
      ObstacleUtils.addBox(
        obstacles,
        gridSize,
        minX = (gridSize * 0.3f).toInt,
        maxX = (gridSize * 0.7f).toInt,
        minY = (gridSize * 0.3f).toInt,
        maxY = (gridSize * 0.7f).toInt,
        minZ = (gridSize * 0.3f).toInt,
        maxZ = (gridSize * 0.7f).toInt,
        0.8f
      )
      ...
      for frameIdx <- 0 until numFrames do
        ...
        val rendered = renderer.renderFrame(densityCurrent, obstacles, gridSize, camera)
