...
class InMemoryCentroidsRepository(
  centroidsRef: Ref[IO, FCMCentroids]
) extends CentroidsRepository:
...
object InMemoryCentroidsRepository:
  ...
  val SegmentLabels: Vector[String] = Vector(
    "Elite VIP", "Premium Loyalist", "High-Value Regular", "Luxury Seeker", "Premium Explorer",
    "Brand Champion", "Loyal Regular", "Steady Shopper", "Consistent Buyer", "Reliable Customer",
    "Rising Star", "Growth Potential", "Accelerating Buyer", "Emerging VIP", "Upward Trend",
    "Active Enthusiast", "Frequent Browser", "Omnichannel Power User", "Mobile Native", "Web Regular",
    "Smart Saver", "Deal Hunter", "Discount Maximizer", "Budget Conscious", "Price Sensitive",
    "Holiday Shopper", "Weekend Warrior", "Evening Buyer", "Morning Shopper", "Lunch Break Browser",
    "New VIP Potential", "Promising Newcomer", "First-Time Buyer", "Curious Explorer", "Trial Customer",
    "Fading VIP", "Declining Loyal", "Dormant Regular", "Churning Risk", "Lapsing Customer",
    "Category Specialist", "Single-Brand Loyalist", "Bulk Buyer", "Gift Giver", "Subscription Seeker",
    "Impulse Buyer", "Planned Purchaser", "Research-Heavy", "Quick Converter", "Browse-Heavy"
  )
