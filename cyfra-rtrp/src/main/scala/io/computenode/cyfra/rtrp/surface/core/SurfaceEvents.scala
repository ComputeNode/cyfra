...
object SurfaceEvent {
  case class SurfaceCreated(
    windowId: WindowId, 
    surfaceId: SurfaceId,
    capabilities: SurfaceCapabilities
  ) extends SurfaceEvent
  
  case class SurfaceDestroyed(
    windowId: WindowId, 
    surfaceId: SurfaceId
  ) extends SurfaceEvent
  
  case class SurfaceRecreated(
    windowId: WindowId, 
    surfaceId: SurfaceId, 
    reason: String,
  ...
  case class SurfaceLost(
    windowId: WindowId, 
    surfaceId: SurfaceId,
    error: String
  ) extends SurfaceEvent
  
  case class SurfaceFormatChanged(
    windowId: WindowId, 
    surfaceId: SurfaceId,
    oldFormat: SurfaceFormat,
    newFormat: SurfaceFormat
  ) extends SurfaceEvent
}