...
class SimulateE2eTest extends munit.FunSuite:
  test("simulate binary operation arithmetic"):
    ...
    val (result, _) = Simulate.sim(expr)
    val expected = 2
